...
import BUS.ChiTietPhieuTra_BUS;
...
public class ChiTietPhieuTraGUI extends JFrame {
    ...
    private String maPT;
    PhieuTra_DTO ptDTO = new PhieuTra_DTO();
    String tenNCC;

    PhieuTra_BUS ptBUS = new PhieuTra_BUS();
    ChiTietPhieuTra_BUS ctptBUS = new ChiTietPhieuTra_BUS();
    ExportPDF exportPDF = new ExportPDF();

    public ChiTietPhieuTraGUI(String maPT) {
        this.maPT = maPT;
        this.ptDTO = ptBUS.getPhieuTraByMaPT(maPT);
        this.tenNCC = ptBUS.getTenNCCByMaPT(maPT);
        initGUI();
    ...
    public void initGUI() {
        ...
        lTitle = new JLabel("CHI TIẾT PHIẾU TRẢ");
        ...
        contentPanel.add(createPanel("Mã phiếu trả: ", maPT), gbc_contentPanel);
        ...
        gbc_contentPanel.gridx = 1;
        gbc_contentPanel.gridy = 1;
        contentPanel.add(createPanel("Ngày tạo: ", ptDTO.getNgayTra().toString()), gbc_contentPanel);
        ...
        String cols[] = {"STT", "Mã SP", "Tên SP", "Số lượng", "Đơn giá"};
        ...
        String tongTienFormmatted = nf.format(ptDTO.getTongTra());
    ...
    public void loadTableChiTietPhieuTra() {
        ArrayList<ChiTietPhieuTra_DTO> listCTPN = ctptBUS.getChiTietPhieuTraByMaPT(maPT);

        modelSanPham.setRowCount(0);
        NumberFormat nf =  NumberFormat.getInstance(new Locale("vi", "VN"));
        int stt = 1;
        for(ChiTietPhieuTra_DTO ctp : listCTPN) {
            String tenSP = ctptBUS.getTenSPByMaSP(ctp.getMaSP());
